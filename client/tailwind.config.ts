		...
		extend: {
			colors: {
				...
				mentor: {
					...
					'primary-glow': 'hsl(var(--mentor-primary-glow))',
					secondary: 'hsl(var(--mentor-secondary))',
					'secondary-glow': 'hsl(var(--mentor-secondary-glow))',
					neutral: 'hsl(var(--mentor-neutral))',
					surface: 'hsl(var(--mentor-surface))',
					glass: 'hsl(var(--mentor-glass))'
				},
				emotion: {
