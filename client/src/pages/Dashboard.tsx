          ...
          <Card className="glass border-border/20">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="w-12 h-12 rounded-lg bg-mentor-secondary/20 flex items-center justify-center">
                  <Clock className="w-6 h-6 text-mentor-secondary" />
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <Card className="glass border-border/20">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <BarChart3 className="w-5 h-5 text-mentor-primary" />
                    Learning Progress
                  </CardTitle>
                    ...
                    {recentSessions.map((session, index) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <ArrowRight className="w-4 h-4 text-muted-foreground group-hover:text-mentor-primary group-hover:translate-x-1 transition-all" />
                        </div>
          ...
          <div className="space-y-8">
            ...
            >
              <Card className="glass border-border/20">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Brain className="w-5 h-5 text-mentor-secondary" />
                    Learning Insights
                  </CardTitle>
                </CardHeader>
