      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="hidden md:flex w-64 flex-col border-r bg-card">
          <div className="p-6 pb-2">
            <h1 className="text-2xl font-bold bg-gradient-to-r from-mentor-primary to-mentor-secondary bg-clip-text text-transparent">
              Settings
            </h1>
                ...
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-left transition-colors ${
                    settings.activeTab === tab.id
                      ? 'bg-mentor-primary/10 text-mentor-primary font-medium'
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center text-center space-y-4 mb-6">
                      <Avatar className="h-24 w-24">
                        ...
                        <AvatarFallback className="text-2xl bg-gradient-to-r from-mentor-primary to-mentor-secondary text-white">
                    ...
                    <div className="mt-6 flex justify-end space-x-3">
                      ...
                      <Button className="bg-gradient-to-r from-mentor-primary to-mentor-secondary hover:opacity-90">
                        Save Changes
                      </Button>
                    </div>
                  </CardContent>
            ...
            {settings.activeTab === 'appearance' && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground">Customize how mento.ai looks on your device</p>
                </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Help improve mento.ai by sharing usage data
                            </p>
                          </div>
                          <Switch 
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Show when you're active on mento.ai
                            </p>
                          </div>
                          <Switch 
            ...
            {settings.activeTab === 'help' && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground">Get help and support for mento.ai</p>
                </div>
                ...
                <Card>
                  <CardContent className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <Button className="w-full bg-gradient-to-r from-mentor-primary to-mentor-secondary hover:opacity-90">
                        Contact Support
                      </Button>
                    </div>
                    ...
                    <div className="space-y-4">
                      <h3 className="font-medium">About mento.ai</h3>
                      <div className="space-y-2 text-sm text-muted-foreground">
                        <p>Version 1.0.0</p>
                        <p>© {new Date().getFullYear()} mento.ai. All rights reserved.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
