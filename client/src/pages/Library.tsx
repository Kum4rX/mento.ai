...
export default function Library() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-mentor-surface via-background to-mentor-surface p-6">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-mentor-primary/50"
              />
            </div>
        ...
        >
          {subjects.map((subject, index) => {
            ...
            return (
              ...
              >
                <Card className="glass border-border/20 hover:border-mentor-primary/20 transition-all duration-300 cursor-pointer h-full">
                  <CardHeader>
                    ...
                    <div className="space-y-3">
                      <div className="flex flex-wrap gap-2">
                        {subject.topics.slice(0, 3).map((topic, topicIndex) => (
                          <span
                            key={topicIndex}
                            className="px-2 py-1 text-xs bg-mentor-primary/10 text-mentor-primary rounded-full"
                          >
                            {topic}
                          </span>
                        ))}
                      ...
                      <Button variant="outline" className="w-full group-hover:bg-mentor-primary/10 group-hover:border-mentor-primary/20">
                        Start Learning
                      </Button>
                    </div>
                  </CardContent>
                ...
                {recentResources.map((resource, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <h4 className="font-medium group-hover:text-mentor-primary transition-colors">{resource.title}</h4>
