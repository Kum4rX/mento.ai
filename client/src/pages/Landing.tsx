...
export default function Landing() {
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center space-y-4">
          ...
          <button 
            ...
            className="px-4 py-2 bg-mentor-primary text-white rounded-lg hover:bg-mentor-primary/90"
          >
            Refresh Page
          </button>
        </div>
        ...
        <div className="text-center space-y-4 max-w-md">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button 
              ...
              className="bg-mentor-primary text-white hover:bg-mentor-primary/90"
            >
              Try Again
            </Button>
            <Button 
  ...
  return (
  <div className="min-h-screen bg-gradient-to-b from-mentor-surface to-background overflow-hidden">
      {/* Animated background elements */}
      <div className="fixed inset-0 -z-10 overflow-hidden">
  <div className="absolute top-1/4 -left-20 w-96 h-96 bg-mentor-primary/5 rounded-full blur-3xl" />
  <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-mentor-secondary/5 rounded-full blur-3xl" />
        
        <motion.div 
          className="absolute top-1/2 left-1/2 w-64 h-64 rounded-full bg-mentor-primary/5 blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.5, 0.8, 0.5],
          }}
      ...
      <div className="container mx-auto px-4 py-16 relative flex flex-col items-center">
        ...
        >
          <motion.div 
            className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-mentor-primary/10 border border-mentor-primary/20 mx-auto"
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ delay: 0.4 }}
          >
            <Sparkles className="w-4 h-4 text-mentor-primary" />
            <span className="text-sm font-medium text-mentor-primary">
          ...
          <motion.h1 
            ...
            variants={fadeInUp}
          >
            Meet <span className="bg-gradient-to-br from-mentor-primary to-mentor-secondary bg-clip-text text-transparent">mento.ai</span>
            <br />
            Your  <span className="bg-gradient-to-br from-mentor-primary to-mentor-secondary bg-clip-text text-transparent">24/7 AI </span>Teacher
          </motion.h1>
        ...
        <div className="relative flex flex-col justify-center items-center w-full mt-9 mb-5">
          ...
          >
            {replica?.thumbnail_video_url ? (
              ...
              <div className="aspect-video bg-gradient-to-br from-mentor-primary/20 to-mentor-secondary/20 flex items-center justify-center border border-white/10">
                <div className="text-center space-y-2">
                  <div className="w-16 h-16 mx-auto bg-mentor-primary/20 rounded-full flex items-center justify-center">
                    <MessageSquare className="w-8 h-8 text-mentor-primary" />
                  </div>
          ...
          >
            ...
            <Button
              variant="outline"
              className="border-mentor-primary text-mentor-primary hover:bg-mentor-primary/10 px-8 py-6 text-base font-medium rounded-xl transition-all duration-300 group"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  key={feature.title}
                  className="group p-6 rounded-xl bg-white/5 border border-white/5 hover:border-mentor-primary/20 transition-all duration-300 hover:-translate-y-1"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1, duration: 0.5 }}
                >
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-mentor-primary to-mentor-secondary flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
