...
**Go to [Render Dashboard](https://dashboard.render.com)** → Select **mentor-backend** → **Environment** tab → **Add/Update these variables:**
...
**Go to [mentor-p8vd.onrender.com](https://mentor-p8vd.onrender.com)** and try starting a session.
