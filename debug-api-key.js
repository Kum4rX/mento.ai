...
console.log('1. Visit: https://mentor-backend.onrender.com/api/debug/config');
...
console.log('curl https://mentor-backend.onrender.com/api/debug/config');
console.log('curl https://mentor-backend.onrender.com/api/tavus/health');