# 🛠️ mento.ai Troubleshooting Guide
...
```bash
# Test backend health
curl https://mentor-backend.onrender.com/api/health

# Test Tavus API connectivity
curl https://mentor-backend.onrender.com/api/tavus/health
```
...
**Backend Environment Variables (mentor-backend):**
- [ ] `NODE_ENV=production`
- [ ] `PORT=3001`
...
**Frontend Environment Variables (mentor-frontend):**
- [ ] `VITE_API_BASE_URL=https://mentor-backend.onrender.com/api`
...
2. Select your **mentor-backend** service
...
1. Open your live site: `https://mentor-p8vd.onrender.com`
